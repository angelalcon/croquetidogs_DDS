...
CREATE TABLE `intentos_login` (
  `id_intentio` int NOT NULL AUTO_INCREMENT,
  `email` varchar(50) NOT NULL,
  `exito` tinyint(1) NOT NULL,
  `ip_origen` varchar(45) NOT NULL,
  `fecha_intento` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `sesiones_id_sesion` int NOT NULL,
  PRIMARY KEY (`id_intentio`),
  KEY `fk_intentos_login_sesiones1_idx` (`sesiones_id_sesion`)
...
-- Dump completed on 2025-09-29 23:13:33
