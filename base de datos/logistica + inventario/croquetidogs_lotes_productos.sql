...
CREATE TABLE `lotes_productos` (
  ...
  PRIMARY KEY (`id_lote`,`productos_id_producto`,`almacenes_id_almacen`),
  KEY `fk_lotes_productos_productos1_idx` (`productos_id_producto`),
  KEY `fk_lotes_productos_almacenes1_idx` (`almacenes_id_almacen`)
