...
--
-- Host: localhost    Database: croquetidogs
-- ------------------------------------------------------
...
CREATE TABLE `cuentas_por_pagar` (
  ...
  `saldo_pendiente` varchar(20) NOT NULL,
  `fecha_emision` date NOT NULL,
  `fecha_vencimiento` date NOT NULL,
  `estado` varchar(50) NOT NULL,
  `proveedores_id_proveedor` int NOT NULL,
  `pagos_id_pago` int NOT NULL,
  `pagos_ventas_id_venta` int NOT NULL,
  PRIMARY KEY (`id_cxp`,`proveedores_id_proveedor`,`pagos_id_pago`,`pagos_ventas_id_venta`),
  KEY `fk_cuentas_por_pagar_proveedores1_idx` (`proveedores_id_proveedor`),
  KEY `fk_cuentas_por_pagar_pagos1_idx` (`pagos_id_pago`,`pagos_ventas_id_venta`)
...
-- Dump completed on 2025-09-29 23:13:32
