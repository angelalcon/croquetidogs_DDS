...
CREATE TABLE `cuentas_por_cobrar` (
  ...
  PRIMARY KEY (`id_cxc`,`clientes_id_cliente`,`pagos_id_pago`),
  KEY `fk_cuentas_por_cobrar_clientes1_idx` (`clientes_id_cliente`),
  KEY `fk_cuentas_por_cobrar_pagos1_idx` (`pagos_id_pago`)
